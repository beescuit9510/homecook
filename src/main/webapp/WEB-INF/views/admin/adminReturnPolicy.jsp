        	...
        	<div class = "main_content">
        		<div class = "main_content_field">
        			...
        			<div class = "amdin_main_content">
						...
						<tr class = "table_head">
							<th>환불 번호</th><th>상품 이름</th><th>처리 비용</th><th>처리 기간</th><th>정책 내용</th>							
						</tr>					
						</table>
...
<script>
	...
	{		
		...
		$.ajax(
		{
			url 	: 	"/getAllRefund.do", 	//서블릿을 요청할지 매핑값 
			data 	:	
			{				
			},								// 서블릿에 전송할 데이터 오브젝트
			type	: 	"get",				// method 설정
			...
			{			
				...
				if(list != null)
				{
					...
					for(var i = 0; i < indexMax; ++i)
					{
						...
						var dealNo = "<td>"+list[i].returnPolicyNo +"</td>";
						var productName = "<td>"+list[i].productName +"</td>";
						var discountRate = "<td>"+list[i].returnShipping + " ₩" +"</td>";
						var discountDate = "<td>"+list[i].retrunLength +"</td>";
						var discountendDate = "<td>"+list[i].policyContent +"</td>";
