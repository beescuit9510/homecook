        	...
        	<div class="main_content2">
        		<div class="side_nav">
        			...
        			<div class="side_nav_content">
	        			<div class="side_nav_div side_nav_div_selected"><span class="side_nav_span side_nav_span_selected"><a href="/manageZcdOrderFrm.do">배달관리</a></span></div>     			
        			</div>
        		</div>
        		
        		<div class="content_div">
        			<div class="content_title">배달관리</div>
        			<div class="content_div_area">
        				<div class="content_div_content">
        					<div class="content_div_info">
        						<div class="content_div_opt1 overflow-text">상호명</div>
        						<div class="content_div_opt2">매장 전화번호</div>
        						<div class="content_div_opt3">배달접수</div>
        					</div>
										...
										<tr class="table_tr_height">
											...
											<td>
												<div class="content_div_opt3">
													<a href="/manageDeliveryOrder.do?reqPage=1&storeNo=${zs.storeNo }&orderState=배달대기" style="color: #9ac6e8;">접수</a>
