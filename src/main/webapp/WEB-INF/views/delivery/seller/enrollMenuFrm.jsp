        								...
        								<div class="container2">
	        								...
	        								<input type="hidden" name="groupNo" value="${groupNo }">
	        									<fieldset>
	        										...
	        										<br>
	        										<span class="info_span">필수 옵션</span>
		        									<hr>
	        										
	        										<div class="row">
	        											<label for="option" class="col-2 col-form-label">옵션 내용</label>
	        											<div class="col-5">
	        												<input type="text" class="form-control" id="menuPrice"
	        											 		name="menuPrice" placeholder="옵션 내용을 입력하세요." maxlength="6">
	        											</div>
	        											<div class="col-4">
															<span class="span_chk" id="menuPriceChk"></span>
														</div>
	        									...
	        									<div class="row">
		        									<a class="cart_btn" style="font-weight: 400; margin-left:200px;" href="/addMenuFrm.do?groupNo=${groupNo }">취소</a>
