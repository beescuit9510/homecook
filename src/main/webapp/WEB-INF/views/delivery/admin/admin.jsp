							...
							<form action="PwChange.do" id="PwChgFrm">
								...
								<div class="content_div_info">
									...
									<input type="hidden" name="memberId"
										value="${requestScope.bsi.memberId }">
									<button onclick="document.getElementById('PwChgFrm').submit()"
										class="buy_btn"
										style="width: 200px; height: 30px; margin-left: 40px; border-radius: 10px; padding: 5px;">비밀번호
										수정</button>
								</div>
							</form>
							<div class="btn-area" style="padding-top: 30px">
								<button type="button" class="buy_btn"
									onclick="document.getElementById('bsiFrm').submit();">변경</button>
